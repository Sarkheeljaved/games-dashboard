...
const Homrpage = () => {
  ...
  return (
    <div className="balance-equation-cover">
      <div className="balance-equation-bgnd">
        <img src="/background.svg" alt="" className="balance-equation-img" />
      </div>
      <button
      ...
      {showModal && (
        <div className="balance-equation-modal-overlay">
          <div className="balance-equation-modal-content">
            <div className="balance-equation-modal-message">{modalMessage}</div>
            <div className="balance-equation-modal-details">
              Left Total: {leftTotal} | Right Total: {rightTotal}
              <div className="balance-equation-modal-card-values">
                <div>
            ...
            <button
              className="balance-equation-modal-close-btn  rounded-circle"
              onClick={closeModal}
            >
      ...
      <div className="balance-equation-balancer-cover">
        <div className="balance-equation-stand">
          <img
            src="/balancer-center-bass-stand.svg"
            className="balance-equation-center-base-stand"
          />
          <div
            ref={drop as any}
            className="balance-equation-balance-Holder"
            style={{
              transform: `rotate(${calculateRotation()})`,
              transformOrigin: "center center",
            }}
          >
            <div className="balance-equation-left-side">
              <img
                src="/balance-left.svg"
                alt="balance-left"
                className="balance-equation-balance-left"
              />
              <div className="balance-equation-left-cards-container">
                {leftSideCards.map((card, index) => (
                  <div
                    key={card.id}
                    className="balance-equation-left-balance-card-img"
                    style={{
                      transform: `rotate(${
                  ...
                  >
                    <div className="balance-equation-card-value">
                      {card.value}
                    </div>
                    <img
                      src={card.image}
                      ...
                      height="80px"
                      alt="balance-card"
                      className="balance-equation-card-img"
                    />
                  </div>
                ))}
              </div>
            ...
            <div className="balance-equation-center-weight-display">
              <div className="balance-equation-weight-value left-weight">
                {leftEquation} = {leftTotal}
              </div>
              <div className="balance-equation-weight-value right-weight">
            ...
            <div className="balance-equation-right-side">
              <img
                src="/balance-right.svg"
                alt="balance-right"
                className="balance-equation-balance-right"
              />
              <div className="balance-equation-right-cards-container">
                {rightSideCards.map((card, index) => (
                  <div
                    key={card.id}
                    className="balance-equation-right-balance-card-img"
                    style={{
                      transform: `rotate(${
      ...
      <div className="balance-equation-persons-container">
        <img src="/child.svg" alt="child" className="" />
        <div className="balance-equation-oldie-message-container">
          <div className="balance-equation-message">
            <img src="/oldie-message.svg" alt="" className="" />
            <div className="balance-equation-text">
          ...
          <img src="/oldie.svg" alt="oldie" className="" />
        </div>
      </div>

      <div className="balance-equation-card-container">
        {cards.map((item) => (
...
const DraggableCard: React.FC<{ card: Card }> = ({ card }) => {
  ...
  return (
    <div
      ref={drag as any}
      className="balance-equation-custom-card-with-value"
      style={{
        opacity: isDragging ? 0.5 : 1,
        cursor: "move",
      }}
    >
      <div className="balance-equation-card-value">{card.value}</div>
